				...
				<article>
					...
					<div className='flex gap-x-4 mt-4'>
						<a href='https://github.com/whyest/' target='_blank'>
							<FaGithubSquare className='h-8 w-8 text-grayishBlue dark:text-emerald-100 hover:text-emerald-600 hover:dark:text-emerald-500 duration-300' />
						</a>
						...
						<a
							...
							target='_blank'
						>
							<FaLinkedin className='h-8 w-8 text-grayishBlue dark:text-emerald-100 hover:text-emerald-600 hover:dark:text-emerald-500 duration-300' />
						</a>

						<a href='https://t.me/whyest' target='_blank'>
							<FaTelegram className='h-8 w-8 text-grayishBlue dark:text-emerald-100 hover:text-emerald-600 hover:dark:text-emerald-500 duration-300' />
						</a>
						<a href='tel:+79031762623' target='_blank'>
							<FaWhatsappSquare className='h-8 w-8 text-grayishBlue dark:text-emerald-100 hover:text-emerald-600 hover:dark:text-emerald-500 duration-300' />
						</a>
					</div>
				</article>
